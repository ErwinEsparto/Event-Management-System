    ...
    <div id="registerInfo" class="registerInfo">
        <div class="registerInfo-container">
            <form class="registrationForm" action="http://localhost/Event-Management-System/dbConnections/eventsdb.php" method="post">
                ...
                <div class="contentContainer"><p style="font-size: 32px; padding: 15px;text-align: center; color:white; font-family:monospace; background-color:blueviolet;">Student Information<hr></p></div>
                <div class="contentContainer" style="display:block;">
                    <div class="register-content" style="text-align: center; padding: 20px;">
                        ...
                        <div style="padding-top: 20px;"><a href="#" class="abttn"><button type="submit" name="registerNow" style="background-color: transparent; border: none;">Submit</button></a></div>
                    </div>
                </div>
            </form>
        </div>
